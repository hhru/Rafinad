...
/// который позволяет описать структуру и возможности компонента для тестов.
///
...
/// - ``AnyAccessibility``: cхема компонентов со стертым типом
/// - ``ScreenAccessibility``: схема экрана
///
/// Этого набора достаточно, чтобы описать структуру любого UI-компонента и экрана в целом,
...
///
/// Чтобы описать дополнительные возможности компонента для тестов,
